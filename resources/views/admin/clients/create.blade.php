...
@section('title', 'Gestione Clienti | ' . config('app.name'))

@section('content')
<div class="container py-5">
    {{-- Header --}}
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="text-white fw-bold text-uppercase mb-0">Gestione Clienti</h1>
        ...
        <div class="col-lg-4">
            <div class="card bg-dark text-white border-light shadow-lg">
                <div class="card-header border-light bg-black p-3 text-center">
                    <h5 class="mb-0 fw-bold text-uppercase text-primary">Registra Nuovo Cliente</h5>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('admin.clients.store') }}" method="POST">
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-outline-primary fw-bold py-2 text-uppercase">
                                <i class="bi bi-person-plus-fill"></i> Registra Cliente
                            </button>
                        </div>
                    </form>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pe-4 text-end">
                                            <div class="d-flex justify-content-end gap-2">
                                                <a href="{{ route('admin.users.show', $client->id) }}" class="btn btn-sm btn-warning">
